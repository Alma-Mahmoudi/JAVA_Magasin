 ...
 * @author asus
 */
public class JardinPleinAir extends javax.swing.JFrame {

    /**
     * Creates new form JardinPleinAir
     */
    public JardinPleinAir() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JardinPleinAir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JardinPleinAir().setVisible(true);
            }
        });
    }
